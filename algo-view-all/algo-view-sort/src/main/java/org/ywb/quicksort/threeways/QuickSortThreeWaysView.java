...
import org.ywb.quicksort.twoway.QuickSortTwoWayController;
...
public class QuickSortThreeWaysView {
    public static void main(String[] args) {
        ...
        QuickSortThreeController controller = new QuickSortThreeController(quickSortFrame, 50);
